namespace Senac.Consultorio
{
    partial class FormAtendimento
    {
        ...
        private void InitializeComponent()
        {
            ...
            cmbPaciente.Location = new Point(25, 68);
            cmbPaciente.Name = "cmbPaciente";
            cmbPaciente.Size = new Size(191, 23);
            cmbPaciente.TabIndex = 2;
            cmbPaciente.ValueMember = "CPF";
            // 
            // cmbProcedimento
            // 
            cmbProcedimento.DisplayMember = "Nome";
            cmbProcedimento.FormattingEnabled = true;
            cmbProcedimento.Location = new Point(25, 128);
            cmbProcedimento.Name = "cmbProcedimento";
            cmbProcedimento.Size = new Size(191, 23);
            cmbProcedimento.TabIndex = 3;
            // 
            // btnAtender
            // 
            btnAtender.Location = new Point(141, 182);
